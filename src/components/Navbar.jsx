...
//Fonts
import { faAddressCard,faBriefcase, faBookReader, faPaperPlane, faMoon, faAngleDoubleLeft } from "@fortawesome/free-solid-svg-icons";
    ...
    <div>
      <nav className="navbar">
        <ul className="navbar__nav">
            <li className="logo">
                ...
                <FontAwesomeIcon id="navbar__logo" className="navbar__icon"  icon={faAngleDoubleLeft} />
      ...
      <main>
        ...
        <p>
          ...
          consequuntur rerum quia dolor corporis iure recusandae consectetur aut
          dicta ipsam id reiciendis exercitationem sint sunt, magnam illum esse
          odio officia.
        </p>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat
